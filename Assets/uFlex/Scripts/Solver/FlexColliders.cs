    ...
    public class FlexColliders : MonoBehaviour
    {
        ...
        public void ProcessColliders(IntPtr solverPtr, Flex.Memory memory)
        {
            ...
            for (int i = 0; i < m_collidersCount; i++)
            {
                ...
                Flex.UpdateTriangleMesh(meshPtr, vertices, triangles, mesh.vertexCount, mesh.triangles.Length / 3, localLowerBound, localUpperBound, memory);
                ...
                m_collidersFlags[i] = Flex.MakeShapeFlags(Flex.CollisionShapeType.eFlexShapeTriangleMesh, false);
            }
