        ...
        void OnGUI()
        {
            ...
            if (Selection.activeGameObject)
            {
                ...
                if (particles)
                {
                    ...
                    if (GUILayout.Button("Upgrade to v0.4"))
                    {
                        particles.m_densities = new float[particles.m_particlesCount];
                        particles.m_velocities = new Vector3[particles.m_particlesCount];
                        particles.m_particlesActivity = new bool[particles.m_particlesCount];
