...
namespace uFlex
{
    ...
    //    float massRandomness = 0.0f;
        ...
        void OnGUI()
        {
            ...
            GUILayout.Label("uFlex v0.45", EditorStyles.whiteLargeLabel);
        ...
        private void GenerateFromMesh(GameObject go)
        {
            ...
            {      
                ...
                if (flexAsset.mNumParticles > 0)
                {
                    ...
                    part.m_particles = new Particle[flexAsset.mNumParticles];
                ...
                if (softMesh)
                {
                    ...
                    if (bodyType == FlexBodyType.Cloth || bodyType == FlexBodyType.Inflatable)
                    {
